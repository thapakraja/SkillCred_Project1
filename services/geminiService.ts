...
export const generateQuizFromText = async (text: string, questionCount: number): Promise<Quiz> => {
    ...
    if (!apiKey) {
      throw new Error("API_KEY environment variable not set. Please create a .env.local file with GEMINI_API_KEY=your_api_key_here. Get your API key from https://makersuite.google.com/app/apikey");
    }
